...
@section('content')
    @include('spark::components.page-title', array('title' => 'Settings'))
    <spark-settings :user="user" :teams="teams" inline-template>
        <div class="spark-screen page-content--has-footer">
          <div class="container">
            <div class="row">
                  <!-- Tabs -->
                ...
                1-2 2-2h4V2c0-1 1-2 2-2s2 1 2 2v2h4c1 0 2 1 2 2v4h-2c-1 0-2 1-2 2s1 2 2 2h2z "/>
                      ...
                      <!-- Billing Tabs -->
                      @if (Spark::canBillCustomers() && false)
                          <aside>
                ...
                1 .5 1 1v1zm1 18c-1 0-2-1-2-2s1-2 2-2 2 1 2 2-1 2-2 2zm10 0c-1 0-2-1-2-2s1-2 2-2 2 1 2 2-1 2-2 2z " />
                  ...
                  <!-- Tab cards -->
                  <div class="col-md-9 spark-settings-contents">
